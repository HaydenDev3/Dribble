...
//   private _reactions: Map<string, MessageReaction> = new Map();
  ...
  public get channel(): BaseChannel { return this._channel; }
  public get author(): User { return this._author; }
...
//         return new MessageReaction(this.channel.client, guildEmoji, this, true, new Map<string, User>());
//       }
...
//    * @returns null
//    */
//   public async edit(payload: string | any) {
