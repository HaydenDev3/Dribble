...
export default class Guild {
  ...
  public get roles(): Map<string, Role> { return this._roles; }
  public set roles(roles: Map<string, Role>) { this._roles = roles; }

  public get emojis(): Map<string, any> { return this._emojis; }
  public set emojis(emojis: Map<string, any>) { this._emojis = emojis; }

  public get channels(): Map<string, BaseChannel> { return this._channels; }
  public set channels(channels: Map<string, BaseChannel>) { this._channels = channels; }

  public get name() { return this._name; }
  public set name(name: string) { this._name = name; }

  public get members(): Map<string, GuildMember> { return this._members; }
  public set members(members: Map<string, GuildMember>) { this._members = members; }
